    ...
    <>
      <div>
        ...
        <div className='w-full bg-image-one py-[50px] sm:py-[60px] text-center px-4'>
          <h2 className='text-[25px] sm:text-[28px] sm:leading-[51.2px] max-w-[600px] mx-auto font-alethia text-white'>I view my life as before psychedelics, and after psychedelics.</h2>
        </div>
      </div>
      ...
      <div className='-mt-1 w-full bg-image-two flex lg:items-center lg:flex-row flex-col justify-between gap-10 xl:gap-20 relative'>
        <Image src='/assets/profile-one.png' alt='profile-one' width={706} height={729} className='xl:w-[706px] w-[600px]' />
        <div className='lg:max-w-[600px] mx-auto px-4 md:px-10 lg:pr-[40px] xl:pr-[127px] pt-[20px] pb-[50px] sm:pt-[40px] sm:pb-[60px] lg:py-[100px]'>
      ...
      <div className='-mt-1 w-full bg-image-three flex lg:items-center lg:flex-row flex-col-reverse justify-between gap-10 xl:gap-20 relative'>
        <div className='lg:max-w-[800px] mx-auto px-4 md:px-10 lg:pl-[40px] xl:pl-[100px] pt-[20px] pb-[40px]'>
        ...
        <Image src='/assets/profile-two.png' alt='profile-one' width={706} height={729} className='xl:w-[706px] w-[600px]' />
      </div>
      ...
      <div className='-mt-1 w-full bg-image-four flex lg:items-center lg:flex-row flex-col justify-between gap-10 xl:gap-20 relative'>
        <Image src='/assets/profile-image-three.svg' alt='profile-one' width={706} height={729} className='xl:w-[706px] w-[600px]' />
